...
public class RENT_Your_CommercialFragment extends BaseFragment implements CommissionListenerFactory.RentOutCommissionListener, NoInternetTryConnectListener, CustomListener, AllUtils.RequestReachedListener {
                    ...
                    if (response != null && response.isSuccessful()) {
                        ...
                        try {
                            ...
                            if ((jObjError.getString("message").equals("Invalid Access Token"))) {
                                ...
                                AllUtils.showMaxRequestReached(context,jObjError.getString("message"),RENT_Your_CommercialFragment.this);
                            }
                            else {
