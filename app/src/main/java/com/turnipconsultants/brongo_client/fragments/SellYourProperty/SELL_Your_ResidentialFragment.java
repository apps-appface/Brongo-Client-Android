...
public class SELL_Your_ResidentialFragment extends BaseFragment implements CommissionListenerFactory.SellCommissionListener, NoInternetTryConnectListener, CustomListener {
    ...
    private String[] houseOrientationArray = new String[]{"East", "Wes", "North", "South", "North-East", "South-East", "North-West", "South-West", "Any"};

    private Context context;
    private String headerToken, headerDeviceId, headerPlatform;
    private SharedPreferences pref;
    private String popLocStr = "", propTypeStr = "", propStatusStr = "", bedroomStr = "", floorStr = "Any", furnishedStr = "Any", houseOrientationStr = "Any", commission = "";
