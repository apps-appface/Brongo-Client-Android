...
public class PastReqClosedFragment extends Fragment {
    ...
    private final String DEAL_TYPE = "CLOSED";
    ...
    public MutableLiveData<PastRequirementResponse> getApiResponseModel() {
