...
import com.turnipconsultants.brongo_client.models.SellYourProperty.SellYourProperty;
...
@Data
public class SellLandComViewModel extends ViewModel {
    private MutableLiveData<PropertyTransactionResponseModel> apiResponseData;
    private SellLandComRepository repository = SellLandComRepository.getInstance(getApiResponseData());
    ...
    public void makeSeverCall(Context context, String accessToken, String platform, String deviceId, String clientMobile, Map<String, RequestBody> partMap, MultipartBody.Part propertyPicture1, MultipartBody.Part propertyPicture2, MultipartBody.Part propertyPicture3) {
        apiResponseData = repository.postSellLandCommercial(context, accessToken, platform, deviceId, clientMobile, partMap, propertyPicture1, propertyPicture2, propertyPicture3);
    }
